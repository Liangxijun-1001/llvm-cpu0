...
entry:
; CHECK: move  $fp, $sp
; CHECK: subu  $[[T0:[0-9]+|t9]], $sp, $[[SZ:[0-9]+|t9]]
; CHECK: addu  $sp, $zero, $[[T0]]
; CHECK: subu  $[[T2:[0-9]+|t9]], $sp, $[[SZ]]
...
; CHECK: ld  ${{[0-9]+|t9}}, 0($[[T0]])
; CHECK: ld  $t9, %call16(printf)
